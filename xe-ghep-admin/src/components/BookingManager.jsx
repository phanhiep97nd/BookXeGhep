...
const BookingManager = () => {
  ...
  const convertStatus = (status) => {
    switch (status) {
      ...
      case '1': return '📵Liên lạc chưa thành công';
              ...
              <tbody className="divide-y divide-gray-200">
                {bookings.map((booking) => (
                  <tr
                    ...
                    onKeyDown={(e) => e.key === 'Enter' && openModalConfirm(booking)}
                  >
                    ...
                    <td className="px-2 py-2 whitespace-nowrap truncate">
                      <a href={`tel:${booking.phoneNumber}`} className="text-blue-600 hover:underline" onClick={(e) => e.stopPropagation()}>
                        {booking.phoneNumber}
                      </a>
                    </td>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-40">
          <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-md">
            ...
            <table className="mb-4 min-w-full text-sm text-left text-gray-700 table-fixed">
              <tbody>
                <tr>
                  <th className="w-40 pr-4 py-1 font-medium text-gray-700 align-top">Booking ID</th>
                ...
                <tr>
                  <th className="w-40 pr-4 py-1 font-medium text-gray-700 align-top">Địa điểm đón</th>
                  <td className="py-1 break-all whitespace-normal">{currentBooking.pickupFrom}</td>
                </tr>
                <tr>
                  <th className="w-40 pr-4 py-1 font-medium text-gray-700 align-top">Địa điểm trả</th>
                  <td className="py-1 break-all whitespace-normal">{currentBooking.destination}</td>
                </tr>
                <tr>
                  <th className="w-40 pr-4 py-1 font-medium text-gray-700 align-top">Số lượng khách</th>
                ...
                <tr>
                  <th className="w-40 pr-4 py-1 font-medium text-gray-700 align-top">Ghi chú(người đặt)</th>
            ...
            <div className="mb-4">
              ...
              <ul className="grid grid-cols-4 gap-2 p-0">
                {[
                  { id: "0", label: "📞Chưa kiểm tra", bg: "peer-checked:bg-blue-100" },
                  { id: "1", label: "📵Liên lạc chưa thành công", bg: "peer-checked:bg-yellow-100" },
                  { id: "2", label: "🆗Đã xác nhận", bg: "peer-checked:bg-green-100" },
                  { id: "3", label: "🚫Đã hủy", bg: "peer-checked:bg-red-100" },
                ].map((item) => (
                  <li key={item.id}>
                    <input
                      type="radio"
